// Liste officielle des 69 wilayas et de leurs communes (Algérie)
// Réforme administrative 2025 : 48 wilayas d'origine + 10 (2019) + 11 nouvelles (2025)
// Triée par code de wilaya (01 -> 69)
...
export const COMMUNES_BY_WILAYA = {
  ...
  "03": ["Ain Madhi", "Benacer Benchohra", "El Assafia", "El Haouaita", "Hassi Delaa", "Hassi R'mel", "Kheneg", "Ksar El Hirane", "Laghouat", "Sidi Makhlouf", "Tadjemout", "Tadjrouna"],
  ...
  "05": ["Ain Djasser", "Ain Touta", "Ain Yagout", "Arris", "Batna", "Beni Foudhala El Hakania", "Boulhilat", "Boumagueur", "Boumia", "Bouzina", "Chemora", "Chir", "Djerma", "El Hassi", "El Madher", "Fesdis", "Foum Toub", "Ghassira", "Gosbat", "Guigba", "Hidoussa", "Ichemoul", "Inoughissen", "Kimmel", "Ksar Bellezma", "Larbaa", "Lazrou", "Lemcene", "Maafa", "Menaa", "Merouana", "N Gaous", "Oued Chaaba", "Oued El Ma", "Oued Taga", "Ouled Aouf", "Ouled Fadel", "Ouled Sellem", "Ouled Si Slimane", "Ouyoun El Assafir", "Rahbat", "Ras El Aioun", "Sefiane", "Seriana", "T Kout", "Talkhamt", "Taxlent", "Tazoult", "Teniet El Abed", "Tighanimine", "Tigharghar", "Timgad", "Zanet El Beida"],
  ...
  "07": ["Ain Naga", "Biskra", "Bordj Ben Azzouz", "Bouchakroun", "Chetma", "El Feidh", "El Ghrous", "El Hadjab", "El Haouch", "Foughala", "Khenguet Sidi Nadji", "Lichana", "Lioua", "M'chouneche", "M'lili", "Mekhadma", "Meziraa", "Oumache", "Ourlal", "Sidi Okba", "Tolga", "Zeribet El Oued"],
  ...
  "12": ["Ain Zerga", "Bedjene", "Bekkaria", "Bir Dheheb", "Bir Mokkadem", "Boukhadra", "Boulhaf Dyr", "Cheria", "El Kouif", "El Malabiod", "El Meridj", "El Mezeraa", "El Ogla", "El-Aouinet", "El-Houidjbet", "Guorriguer", "Hammamet", "Morsott", "Ouenza", "Oum Ali", "Saf Saf El Ouesra", "Stah Guentis", "Tebessa", "Telidjen"],
  "13": ["Ain Fetah", "Ain Fezza", "Ain Ghoraba", "Ain Kebira", "Ain Nehala", "Ain Tellout", "Ain Youcef", "Amieur", "Azail", "Bab El Assa", "Beni Bahdel", "Beni Boussaid", "Beni Khellad", "Beni Mester", "Beni Ouarsous", "Beni Smiel", "Beni Snous", "Bensekrane", "Bouhlou", "Chetouane", "Dar Yaghmoracen", "Djebala", "El Fehoul", "Fellaoucene", "Ghazaouet", "Hammam Boughrara", "Hennaya", "Honnaine", "M'sirda Fouaga", "Maghnia", "Mansourah", "Marsa Ben M'hidi", "Nedroma", "Oued Lakhdar", "Ouled Mimoun", "Ouled Riyah", "Remchi", "Sabra", "Sebbaa Chioukh", "Sebdou", "Sidi Abdelli", "Sidi Medjahed", "Souahlia", "Souani", "Souk Tleta", "Terny Beni Hediel", "Tianet", "Tlemcen", "Zenata"],
  "14": ["Ain Bouchekif", "Ain Deheb", "Ain Dzarit", "Ain El Hadid", "Ain Kermes", "Chehaima", "Dahmouni", "Djebilet Rosfa", "Djillali Ben Amar", "Faidja", "Frenda", "Guertoufa", "Madna", "Mahdia", "Mechraa Safa", "Medrissa", "Medroussa", "Meghila", "Mellakou", "Nadorah", "Naima", "Oued Lilli", "Rahouia", "Sebaine", "Sebt", "Si Abdelghani", "Sidi Abderrahmane", "Sidi Ali Mellal", "Sidi Bakhti", "Sidi Hosni", "Sougueur", "Tagdempt", "Takhemaret", "Tiaret", "Tidda", "Tousnina"],
  ...
  "17": ["Ain Chouhada", "Ain El Ibel", "Ain Maabed", "Benyagoub", "Charef", "Dar Chioukh", "Djelfa", "Douis", "El Guedid", "El Idrissia", "Hassi Bahbah", "Hassi El Euch", "M'liliha", "Moudjebara", "Sidi Baizid", "Taadmit", "Zaafrane", "Zaccar"],
  ...
  "26": ["Aissaouia", "Baata", "Ben Chicao", "Beni Slimane", "Berrouaghia", "Bir Ben Laabed", "Bouaichoune", "Bouchrahil", "Bouskene", "Djouab", "Draa Esmar", "El Azizia", "El Guelbelkebir", "El Hamdania", "El Haoudane", "El Omaria", "Hannacha", "Khams Djouamaa", "Maghraoua", "Medea", "Medjebar", "Mezerana", "Mihoub", "Ouamri", "Oued Harbil", "Ouled Bouachra", "Ouled Brahim", "Ouled Deid", "Ouzera", "Rebaia", "Sedraya", "Seghouane", "Si Mahdjoub", "Sidi Naamane", "Sidi Rabie", "Sidi Zahar", "Sidi Ziane", "Souagui", "Tablat", "Tamesguida", "Tizi Mahdi", "Tletat Ed Douair", "Zoubiria"],
  ...
  "28": ["Ain El Hadjel", "Ain Khadra", "Belaiba", "Beni Ilmane", "Berhoum", "Bouti Sayeh", "Chellal", "Dehahna", "Djebel Messaad", "El Houamed", "Hammam Dalaa", "Khettouti Sed-El-Jir", "Khoubana", "M'cif", "M'sila", "Magra", "Ouanougha", "Ouled Addi Guebala", "Ouled Derradj", "Ouled Madhi", "Ouled Mansour", "Sidi Aissa", "Souamaa", "Tarmount"],
  ...
  "32": ["Ain El Orak", "Boualem", "Bougtoub", "El Bayadh", "El Bnoud", "El Kheiter", "El Mehara", "Kef El Ahmar", "Krakda", "Rogassa", "Sidi Ameur", "Sidi Slimane", "Sidi Tiffour", "Stitten", "Tousmouline"],
  ...
  "59": ["Aflou", "Ain Sidi Ali", "Brida", "El Beidha", "El Ghicha", "Gueltat Sidi Saad", "Hadj Mechri", "Oued M'zi", "Oued Morra", "Sebgag", "Sidi Bouzid", "Taouiala"],
  "60": ["Arbaouat", "Boussemghoun", "Brezina", "Cheguig", "Chellala", "Ghassoul", "Labiodh Sidi Cheikh"],
  "61": ["Bouihi", "El Aricha", "El Gor", "Sidi Djillali"],
  "62": ["Ain Zaatout", "Branis", "Djemorah", "El Kantara", "El Outaya"],
  "63": ["Azil Abedelkader", "Barika", "Bitam", "Djezzar", "M Doukal", "Ouled Ammar", "Seggana", "Tilatou"],
  "64": ["Ain El Melh", "Ain Fares", "Ain Rich", "Ben Srour", "Benzouh", "Bir Foda", "Bou Saada", "El Hamel", "M'tarfa", "Maadid", "Maarif", "Medjedel", "Menaa", "Mohamed Boudiaf", "Ouled Sidi Brahim", "Ouled Slimane", "Oulteme", "Sidi Ameur", "Sidi Hadjeres", "Sidi M'hamed", "Slim", "Tamsa", "Zarzour"],
  "65": ["Bir-El-Ater", "El Ogla El Malha", "Ferkane", "Negrine"],
  "66": ["Ain Boucif", "Ain Ouksir", "Aziz", "Boghar", "Bouaiche", "Boughzoul", "Chabounia", "Chelalet El Adhaoura", "Cheniguel", "Derrag", "El Ouinet", "Kef Lakhdar", "Ksar El Boukhari", "M'fatha", "Ouled Antar", "Ouled Emaaraf", "Ouled Hellal", "Oum El Djellil", "Saneg", "Sidi Demed", "Tafraout"],
  "67": ["Bougara", "Hamadia", "Ksar Chellala", "Rechaiga", "Serghine", "Zmalet El Emir Abdelkade"],
  "68": ["Ain Fekka", "Ain Oussera", "Benhar", "Birine", "Bouira Lahdab", "El Khemis", "Guernini", "Had Sahary", "Hassi Fedoul", "Sidi Laadjel"],
  "69": ["Amourah", "Deldoul", "Faidh El Botma", "Guettara", "Messaad", "Oum Laadham", "Sed Rahal", "Selmana"],
};